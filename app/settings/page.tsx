...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-16 px-4 sm:px-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <section className="glass rounded-2xl p-6 space-y-5">
          ...
          <Field
            ...
            placeholder="ex: https://player.videasy.net/movie/{id}"
          ...
          <Field
            ...
            placeholder="ex: https://player.videasy.net/tv/{id}/{season}/{ep}"
