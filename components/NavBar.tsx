  ...
  return (
    <div className="fixed top-6 left-0 right-0 flex justify-center z-50 pointer-events-auto">
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/settings"
          className="bg-white/5 backdrop-blur-md border border-white/10 rounded-full p-4 flex items-center shadow-2xl text-gray-400 hover:text-white transition-colors"
          title="Paramètres"
        >
          <Settings size={18} />
        </Link>
